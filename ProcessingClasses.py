...
# Description: A module to process data
# ChangeLog (Who,When,What):
# RRoot,1.1.2030,Created started script
# IBRAR, 3.21.2021, Created module for Assignment 09 from Listing 7
# ---------------------------------------------------------- #
...
class FileProcessor:
    ...
    changelog: (When,Who,What)
        ...
        IBRAR, 3.21.2021, Modified for assignment
    """
    ...
    def save_data_to_file(file_name: str, list_of_objects: list):
        ...
        return "Data successfully saved to the file!"
